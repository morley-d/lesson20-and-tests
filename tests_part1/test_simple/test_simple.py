...
def test_sum():
    ...
    assert summer(1, 2, 3) == 6, "Функция не правильно складывает числа"

def test_big_number():
    # TODO Напишите Ваш код здесь
    assert summer(100, 200, 300) == "Большое число", "Функция не определяет большие числа"
...
def test_wrong_arg():
    # TODO Напишите Ваш код здесь
    assert summer(1, "эге", 3) == "ОШИБКА", "Функция не перехватывает ошибки или делает это неверно"
